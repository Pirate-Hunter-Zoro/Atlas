...
\begin{problem}{3}
  \emph{Degrees.} Let $K/F$ be a finite extension of degree $n$.

  \begin{enumerate}
    \item[(a)] Show that for any $\alpha \in K$, the degree of $m_{\alpha,F}$
      divides $n$.
    \item[(b)] Show that if $n$ is prime, there are no fields strictly between
      $F$ and $K$.
    \item[(c)] Show that $\sqrt{2} \notin \mathbb{Q}(\sqrt[3]{2})$.
  \end{enumerate}
\end{problem}
...
\begin{solution}
  \textbf{(a)} Let $[K:F] = n$ and let $\alpha \in K$.
