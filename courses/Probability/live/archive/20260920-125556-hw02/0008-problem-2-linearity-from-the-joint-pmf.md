...
---
That page is the Cov(X+Y,Z) proof from **Problem 1**. It is correct and it is already filed — you proved it earlier today, and nothing on it needs redoing. It is the wrong page for the open question, that is all.

The open question is Problem 2, and nothing has been written on it yet. Here it is in full again so you do not have to scroll.
...
Then tell me what those two numbers *are* — name them as probabilities about $X_1$ alone. Two numbers and one sentence is the whole answer.
