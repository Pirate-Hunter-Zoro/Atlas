#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# build.sh — compile one .tex file into the nearest chNN/hwNN build/ directory.
#
#   ./scripts/build.sh chapters/ch03-*/notes/ch03-notes.tex
#   ./scripts/build.sh homework/hw02/hw02.tex
#
...
# Walk up to the nearest chNN-* / hwNN unit directory; build there.
unit="$(dirname "$src")"
